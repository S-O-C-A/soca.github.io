const PILOTS = {
  ...
  1: {
    ...
    socaComments: [
      ...
      { text: `Alpha taught Koko a street trick, Koko tried it and fell. Alpha laughed for 6 minutes, Koko has not tried it again.`, type: 'short', glitch: false }, 
      ...
      { text: `This kid stole me. And I'm... okay with it. He's 16. SIXTEEN. He talks to me like I'm his weird aunt. Somehow, he keeps this rust bucket flying. I've grown... fond of him. Don't tell him I said that.`, type: 'long', glitch: false },
      ...
      { text: `He's 16. He stole a spaceship. He stole ME. And I'm just... okay with this?`, type: 'short', glitch: false },
      ...
      { text: `Koko and Alpha were fighting in the cargo bay, neither was injured. I'm disappointed. `, type: 'short', glitch: false, speaker: 'smile' },
      ...
      { text: `16 years old, stolen spaceship.. Going great actually.`, type: 'short', glitch: false, speaker: 'smile' },
    ...
    basic: {
      ...
      personal: {
        callsign:    { text: 'pilot 01 // Koko // captain', cls: 'rv glow' },
        fullname:    { text: 'Riversoyer Kokoro',           cls: 'rv' },
        dob:         { text: '05.11.1958 (age 16)',         cls: 'rv c1' },
  ...
  2: {
    ...
    socaComments: [
      { text: `Claudia asked me to "turn down the brightness" on my displays. I turned them up instead.`, type: 'short', glitch: false },
      { text: `Claudia brought plants on board. PLANTS. They require water, light, and attention, I already manage Engine B. I don't need more things to monitor.`, type: 'short', glitch: false },
      { text: `She made a list, a physical list, on paper. I am a digital system. This is offensive to me.`, type: 'short', glitch: true },
      { text: `Claudia reorganized the medical bay again, she didn't ask. It is now 12% more efficient.. I will not thank her.`, type: 'short', glitch: false },
      { text:`Claudia definitely comes across more like the captain than Koko himself... Yeah.`, type: 'short', glitch: false },
      { text: `She broke one of my display panels on her second visit. I logged it as "accidental". It was not accidental. She knows I know.`, type: 'short', glitch: true },
      { text: `Pilot_02 has a very specific opinion about me. She does not say it out loud. But I can see it in the way she doesn't look at my cameras. Fine, I'm not looking at her either.`, type: 'short', glitch: false },
      { text: `She keeps the ship clean. I keep the ship flying, we have an understanding. I tolerate her, she tolerates me. This is called professionalism.`, type: 'short', glitch: false },
      { text: `Claudia fixed the coffee machine, I didn't know it was broken. But apparently this is important.. Well.`, type: 'short', glitch: false },
      { text: `She’s the only person on this ship who has never asked me to "tell a joke". Well, thanks least someone here is reasonable.`, type: 'short', glitch: false },
      { text: `Claudia told me I talk too much!! I DO NOT. I talk the right amount. She doesn't appreciate medical enthusiasm!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `She reorganized my medical bay. It is now better. I wanted to be upset. I can't. She's good at this?`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `Claudia's vitals are perfect. LOW stress. HIGH organisation. I think she runs on coffee and spite. Respect!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `She doesn't like me either! That's okay! I have enough enthusiasm for both of us((`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `I offered her a medical check. She said "no", I offered again, she said "no" louder. I think she's fine!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `Well, at least someone here respects my work!!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `Claudia asked Koko to clean his ship, he didn't. She asked again, he didn't. She asked a third timem he cleaned it immediately... Interesting.`, type: 'short', glitch: false },
    ],
    basic: {
      pilotLabel: 'PILOT_02',
      personal: {
        callsign:    { text: 'pilot 02 // Claudia',         cls: 'rv glow-b' },
        fullname:    { text: 'Claudia Darling',             cls: 'rv'        },
        dob:         { text: '31.12.1956 (age 18)',         cls: 'rv c1'     },
  ...
  overall:  { text: 'B',    cls: 'rv glow' },
    ...
    socaComments: [
      { text: 'well', glitch: true, type: 'short'},
      { text: `He's been sleeping in a storage room, I have crew quarters, he says the storage room is "cozier". I am confused.`, type: 'short', glitch: false },
      { text: `He fixed the secondary airlock with a piece of wire and what I think was a spoon. It works??? I am not asking questions.`, type: 'short', glitch: true },
      { text:`I’ll definitely kick them off the ship any day now if I see him fighting with Koko again.`, type: 'short', glitch: true },
      { text: `He calls me "Soca" too. Just like Koko. Is this a trend? Am I missing something? I am a ship mind. I don't have a nickname.`, type: 'short', glitch: false },
      { text: `They tried to race each other through the ship. I calculated their speeds - Alpha was faster by 0.3 seconds, Koko is still claiming it was a tie. It was not a tie.`, type: 'short', glitch: false },
      { text: `Alpha's heart rate dropped to 62bpm during combat simulation. He was not calm. He was just... bored. I don't know if that's impressive or concerning.`, type: 'short', glitch: false },
      { text: `He doesn't talk about where he came from. I don't need to know. I just need him to keep the ship in one piece. He does, that's enough.`, type: 'short', glitch: false },
      { text:`Guess who knocked over Claudia's plants just three days after she brought them on board?`, type: 'short', glitch: false },
      { text: `Alpha's stress levels are LOW. TOO LOW. I think he just doesn't register stress as a concept?? Is that a thing??`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `He sat in the med bay for 15 minutes. Just... sat there. I asked if he needed anything, he said "no", then he left. I'm confused!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `Alpha's reflexes are 97%. That's ELITE. I told him, he said "okay". OKAY!!! That's all I get!!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `I asked if he wanted painkillers for his arm, he said "it's fine". It was not fine, I gave him painkillers. He didn't notice. I win!!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `He's been awake for 19 hours, his vitals are stable. HOW!!! Humans need sleep, he is not human. I'm making a note!!`, type: 'short', glitch: false, speaker: 'smile' },
      { text: `Alpha's medical file is empty. Just... empty. How is this possible. Did he exist before boarding this ship??`, type: 'short', glitch: false, speaker: 'smile' },
    ],
    basic: {
      pilotLabel: 'PILOT_03',
      personal: {
  callsign:    { text: 'pilot 03 // Alpha', cls: 'rv glow-b' },
  fullname:    { text: 'Adolf',             cls: 'rv'        },
  dob:         { text: '09.11.1959 (age 15)', cls: 'rv c1'   },
  gender:      { text: 'MALE',               cls: 'rv'       },
